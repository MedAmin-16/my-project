        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-3 gap-10">
            <div className="terminal-card p-10 rounded-xl border border-matrix/30 hover:border-matrix/50 transition-all">
              <div className="mb-8">
                <h3 className="text-2xl font-mono text-light-gray mb-2">Starter</h3>
                <p className="text-dim-gray text-sm">Perfect for smaller organizations</p>
              </div>
              <div className="mb-8">
                <span className="text-4xl font-mono text-matrix font-bold">15%</span>
                <span className="text-dim-gray text-lg"> platform fee</span>
                <p className="text-dim-gray text-sm mt-2">Only pay when vulnerabilities are found</p>
              </div>
              <ul className="space-y-4 mb-10">
                <li className="flex items-center text-dim-gray">
                  <CheckCircle className="h-5 w-5 text-matrix mr-4" />
                  <span className="font-mono">Up to 100 researchers</span>
                </li>
                <li className="flex items-center text-dim-gray">
                  <CheckCircle className="h-5 w-5 text-matrix mr-4" />
                  <span className="font-mono">Basic dashboard & analytics</span>
                </li>
                <li className="flex items-center text-dim-gray">
                  <CheckCircle className="h-5 w-5 text-matrix mr-4" />
                  <span className="font-mono">Email support</span>
                </li>
                <li className="flex items-center text-dim-gray">
                  <CheckCircle className="h-5 w-5 text-matrix mr-4" />
                  <span className="font-mono">Standard SLA</span>
                </li>
                <li className="flex items-center text-dim-gray">
                  <CheckCircle className="h-5 w-5 text-matrix mr-4" />
                  <span className="font-mono">Basic integrations</span>
                </li>
              </ul>
              <Button className="w-full border border-matrix/50 text-matrix hover:bg-matrix/10 py-6 text-lg font-mono" variant="outline">
                Start Free Trial
              </Button>
            </div>

            <div className="terminal-card p-10 rounded-xl border-2 border-matrix animate-pulse-glow relative">
              <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
                <span className="bg-matrix text-black px-4 py-2 rounded-full text-sm font-mono font-bold">Most Popular</span>
              </div>
              <div className="mb-8">
                <h3 className="text-2xl font-mono text-light-gray mb-2">Professional</h3>
                <p className="text-dim-gray text-sm">Ideal for growing enterprises</p>
              </div>
              <div className="mb-8">
                <span className="text-4xl font-mono text-matrix font-bold">12%</span>
                <span className="text-dim-gray text-lg"> platform fee</span>
                <p className="text-dim-gray text-sm mt-2">Volume discounts available</p>
              </div>
              <ul className="space-y-4 mb-10">
                <li className="flex items-center text-dim-gray">
                  <CheckCircle className="h-5 w-5 text-matrix mr-4" />
                  <span className="font-mono">Up to 500 researchers</span>
                </li>
                <li className="flex items-center text-dim-gray">
                  <CheckCircle className="h-5 w-5 text-matrix mr-4" />
                  <span className="font-mono">Advanced analytics & reporting</span>
                </li>
                <li className="flex items-center text-dim-gray">
                  <CheckCircle className="h-5 w-5 text-matrix mr-4" />
                  <span className="font-mono">Priority support (24/7)</span>
                </li>
                <li className="flex items-center text-dim-gray">
                  <CheckCircle className="h-5 w-5 text-matrix mr-4" />
                  <span className="font-mono">API access & webhooks</span>
                </li>
                <li className="flex items-center text-dim-gray">
                  <CheckCircle className="h-5 w-5 text-matrix mr-4" />
                  <span className="font-mono">Advanced integrations</span>
                </li>
                <li className="flex items-center text-dim-gray">
                  <CheckCircle className="h-5 w-5 text-matrix mr-4" />
                  <span className="font-mono">Custom workflows</span>
                </li>
              </ul>
              <Button className="w-full glow-button py-6 text-lg font-mono">
                Get Started
              </Button>
            </div>
            ...
            <div className="terminal-card p-10 rounded-xl border border-matrix/30 hover:border-matrix/50 transition-all">
              <div className="mb-8">
                <h3 className="text-2xl font-mono text-light-gray mb-2">Enterprise</h3>
                <p className="text-dim-gray text-sm">For large-scale organizations</p>
              </div>
              <div className="mb-8">
                <span className="text-4xl font-mono text-matrix font-bold">Custom</span>
                <span className="text-dim-gray text-lg"> pricing</span>
                <p className="text-dim-gray text-sm mt-2">Tailored to your requirements</p>
              </div>
              <ul className="space-y-4 mb-10">
                <li className="flex items-center text-dim-gray">
                  <CheckCircle className="h-5 w-5 text-matrix mr-4" />
                  <span className="font-mono">Unlimited researchers</span>
                </li>
                <li className="flex items-center text-dim-gray">
                  <CheckCircle className="h-5 w-5 text-matrix mr-4" />
                  <span className="font-mono">Dedicated account manager</span>
                </li>
                <li className="flex items-center text-dim-gray">
                  <CheckCircle className="h-5 w-5 text-matrix mr-4" />
                  <span className="font-mono">White-label options</span>
                </li>
                <li className="flex items-center text-dim-gray">
                  <CheckCircle className="h-5 w-5 text-matrix mr-4" />
                  <span className="font-mono">SOC 2 Type II compliance</span>
                </li>
                <li className="flex items-center text-dim-gray">
                  <CheckCircle className="h-5 w-5 text-matrix mr-4" />
                  <span className="font-mono">On-premise deployment</span>
                </li>
                <li className="flex items-center text-dim-gray">
                  <CheckCircle className="h-5 w-5 text-matrix mr-4" />
                  <span className="font-mono">Custom SLA agreements</span>
                </li>
              </ul>
              <Button className="w-full border border-matrix/50 text-matrix hover:bg-matrix/10 py-6 text-lg font-mono" variant="outline">
                Contact Sales
