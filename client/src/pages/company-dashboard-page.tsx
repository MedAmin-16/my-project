              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div className="grid grid-cols-1 gap-4 bg-primary/5 p-4 rounded-md">
                    <div>
                      <div className="text-sm text-dim-gray">Company Name</div>
                      <div className="font-medium">{user?.companyName || user?.username}</div>
                    </div>
                    <div>
                      <div className="text-sm text-dim-gray">Company Size</div>
                      <div className="font-medium">{user?.companySize || "Not specified"}</div>
                    </div>
                    <div>
                      <div className="text-sm text-dim-gray">Industry</div>
                      <div className="font-medium">{user?.companyIndustry || "Not specified"}</div>
                    </div>
                    <div>
                      <div className="text-sm text-dim-gray">Website</div>
                      <div className="font-medium text-matrix hover:underline">
                        <a href={user?.companyWebsite} target="_blank" rel="noopener noreferrer">
                          {user?.companyWebsite || "Not specified"}
                        </a>
                      </div>
                    </div>
                    <div>
                      <div className="text-sm text-dim-gray">Contact Email</div>
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center justify-between bg-primary/5 p-3 rounded-md">
                      <div>
                        <div className="font-medium">New Submission Alerts</div>
                        <div className="text-sm text-dim-gray">Get notified when a researcher submits a new vulnerability</div>
                      </div>
                      <div className="flex items-center">
                        <div className="w-10 h-5 bg-matrix rounded-full relative">
                    ...
                    <div className="flex items-center justify-between bg-primary/5 p-3 rounded-md">
                      <div>
                        ...
                        <div className="text-sm text-dim-gray">Receive a weekly overview of your program activity</div>
                      </div>
                      <div className="flex items-center">
                        <div className="w-10 h-5 bg-matrix rounded-full relative">
                          <div className="w-4 h-4 bg-white rounded-full absolute top-0.5 right-0.5"></div>
                    ...
                    <div className="flex items-center justify-between bg-primary/5 p-3 rounded-md">
                      <div>
                        ...
                        <div className="text-sm text-dim-gray">Urgent notifications for critical vulnerabilities</div>
                      </div>
                      <div className="flex items-center">
                        <div className="w-10 h-5 bg-matrix rounded-full relative">
                          <div className="w-4 h-4 bg-white rounded-full absolute top-0.5 right-0.5"></div>
